...
@section('content-body')
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-12 col-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h4>Aktifitas Warga</h4>
                </div>
                <div class="card-body">
                    <ul class="list-unstyled list-unstyled-border">
                        <li class="media">
                            <img class="mr-3 rounded-circle" width="50" src="{{ asset('assets/stisla/img/avatar/avatar-1.png') }}"
                                 alt="avatar">
                        ...
                        <li class="media">
                            <img class="mr-3 rounded-circle" width="50" src="{{ asset('assets/stisla/img/avatar/avatar-2.png') }}"
                                 alt="avatar">
                            <div class="media-body">
                        ...
                        <li class="media">
                            <img class="mr-3 rounded-circle" width="50" src="{{ asset('assets/stisla/img/avatar/avatar-3.png') }}"
                                 alt="avatar">
                            <div class="media-body">
                        ...
                        <li class="media">
                            <img class="mr-3 rounded-circle" width="50" src="{{ asset('assets/stisla/img/avatar/avatar-4.png') }}"
                                 alt="avatar">
                            <div class="media-body">
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0 table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="mr-1 btn btn-primary btn-action" data-toggle="tooltip" title="Edit"><i
...
@push('before-scripts')
    <script src="{{ asset('assets/stisla/js/chart.js/dist/Chart.min.js') }}"></script>
