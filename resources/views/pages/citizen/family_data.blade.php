...
<div class="section-header">
    ...
    <div class="section-header-button">
      <a href="features-post-create.html" class="btn btn-primary">Tambah Data</a>
    </div>
</div>
@endsection
        ...
        <div class="table-responsive">
          <table class="table table-striped">
            ...
            <tr>
              ...
              <td>
                <a href="#">
                  <img alt="image" src="../assets/img/avatar/avatar-5.png" class="rounded-circle" width="35" data-toggle="title" title=""> <div class="ml-1 d-inline-block">Rizal Fakhri</div>
                </a>
              </td>
              <td>2018-01-20</td>
